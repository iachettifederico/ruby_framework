...
%o`, message, error2, detail);
  ...
  // web/assets/js/controllers/hello_controller.js
  ...
  // web/assets/js/controllers/dev_tool_controller.js
  var dev_tool_controller_default = class extends Controller {
    connect() {
      this.translate();
  ...
  Stimulus.register("dev-tool", dev_tool_controller_default);
})();
